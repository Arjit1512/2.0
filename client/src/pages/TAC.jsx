    ...
    return (
        <div className="terms-container">
            ...
            <section className="terms-section">
                ...
                <ul>
                    <li>Republish material from True Hood</li>
                    <li>Sell, rent or sub-license material from True Hood</li>
                    <li>Reproduce, duplicate or copy material from True Hood</li>
                    <li>Redistribute content from True Hood</li>
                </ul>
            </section>
            <section className="terms-section">
                <h2>User Comments</h2>
